  ...
  (package
    ...
    (arguments
     (list
      ...
      ;; One test fails and I'm not sure what the issue is.
      #:tests? #f
      ;; #:phases patched-docker-cli-phases
      #:phases #~(modify-phases %standard-phases
                   ;; The buildkit dependency tree is *massive* and
                   ;; the only thing that's used is the dockerignore
                   ;; module, which is just an alias to
                   ;; github.com/moby/patternmatcher which this
